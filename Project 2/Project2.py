...
class SimulationConfig:
    ...
    def __init__(self, **kwargs):
        ...
        self.dt = 0.7 * dt_max # CFL condition
...
class SimulationRunner:
    ...
    def execute(frame_skip=100, record_ix=None, **kwargs):
        ...
        record_ix = record_ix or int(cfg.x_bar2 / cfg.dx) + int(50e-9 / cfg.dx)
...
results = SimulationRunner.execute(V_DC=0.2, T_total=1.0e-12, E_target=0.35*1.602e-19, frame_skip=200)
